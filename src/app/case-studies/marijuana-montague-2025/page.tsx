            ...
            <div className="relative space-y-12 overflow-hidden">
                ...
                <header className="relative z-10 space-y-4">
                    ...
                    <h1 className="text-4xl font-bold text-sage-900 md:text-5xl">
                        Marijuana in Montague [2025]
                    </h1>
                    <p className="text-lg text-sage-700 max-w-3xl">
                        How comprehensive HLVd testing provided actionable insights for
                        large-scale cannabis cultivators in the Western Cape, enabling early
                        detection and preventing significant crop losses.
                    </p>
                </header>
                ...
                <div className="relative z-10 rounded-xl overflow-hidden shadow-lg">
                    <Image
                        src="/images/marijuana-leaf-lab.jpg"
                        alt="Cannabis leaf sample in laboratory setting"
                        width={1200}
                        height={600}
